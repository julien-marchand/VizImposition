...
/*
 * $Id: common.js 151512 2015-07-24 09:49:03Z pdhing $
...
if ((NYTD.jQuery("meta[name='PT']").attr('content') === 'Section Front' && NYTD.jQuery("meta[name='asset_id']").length > 0) || 
    (NYTD.jQuery("meta[name='PSSST']").length > 0 && NYTD.jQuery("meta[name='PSSST']").attr('content') === 'Section Front' && NYTD.jQuery("meta[name='PT']").attr('content') === 'Topic')) {
        ...
        initialize: function (options) {
            ...
            this.addToPage = function (nodeToAppendTo) {
                ...
                if (options.uniqueId === 'interstitial-ad-modal') {
                     var html = [
                        '<div id="', options.uniqueId + 'Container', '" class="', options.uniqueId + 'Container nytModalContainer">',
                            '<div class="nytOverlay" style="opacity:1;"></div>',
                            '<div class="nytModal ', options.uniqueId, '" style="border: none; height:100%; width:100%;">',
                                options.modalHTML,
                            '</div>',
                        '</div>'
                    ].join('');
...
(function (jQuery) {
    ...
    var modalRegiHtml = [
                '<div class="horizontalFormControl horizontalModalFormControl">',
                    '<form validate id="regiModalForm" class="regiModalForm modalForm" method="post" action="https://myaccount.nytimes.com/register?URI=', window.encodeURIComponent(window.location.href), '">',
    ...
    var modalLoginHtml = [
                '<div class="horizontalFormControl">',
                    '<form id="loginModalForm" class="loginModalForm" method="post" action="https://myaccount.nytimes.com/auth/login?URI=', window.encodeURIComponent(window.location.href), '">',
                        '<div class="control">',
                            '<div class="labelContainer">',
                                '<div class="insetV">',
